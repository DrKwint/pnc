...
from pjsvd import find_optimal_perturbation, apply_correction
...
from ensembles import Ensemble, StandardEnsemble, MCDropoutEnsemble, SWAGEnsemble, LaplaceEnsemble
...
class MNISTExperiment:
    ...
    def run_pjsvd(self, model, n_directions: int, n_perturbations: int,
        ...
        for p_size in perturbation_sizes:
            ...
            self._evaluate_classification(f"PJSVD (size={p_size})", ensembles[p_size])
        return ensembles
...
def main():
    ...
    parser.add_argument("--perturbation_sizes", nargs="+", type=float, default=[20.0, 40.0], help="List of perturbation norms")
